        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentType = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketComments_HousekeepingTickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "HousekeepingTickets",
                        principalColumn: "Id",
