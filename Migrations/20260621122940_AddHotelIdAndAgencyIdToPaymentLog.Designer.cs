...
namespace Booking.Migrations
{
    ...
    [Migration("20260621122940_AddHotelIdAndAgencyIdToPaymentLog")]
    partial class AddHotelIdAndAgencyIdToPaymentLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Booking.Models.HousekeepingTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HousekeepingTickets", (string)null);
                });
            ...
            modelBuilder.Entity("Booking.Models.PaymentLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Booking.Models.Room", b =>
                {
                    ...
                    b.Property<decimal>("ExtendPrice")
                        .HasColumnType("decimal(65,30)");
                    ...
                    b.Property<decimal?>("InsurancePerReservation")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("Booking.Models.SystemLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Booking.Models.TermsAndConditions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Booking.Models.TicketComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RoomRoomAmenity", b =>
                {
                    ...
                    b.ToTable("RoomAmenityMaps", (string)null);
                });
            ...
            modelBuilder.Entity("Booking.Models.HousekeepingTicket", b =>
                {
                    b.HasOne("Booking.Models.ApplicationUser", "AssignedTo")
                        .WithMany()
                        .HasForeignKey("AssignedToId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Booking.Models.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Booking.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("Booking.Models.ApplicationUser", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Booking.Models.SystemLog", b =>
                {
                    b.HasOne("Booking.Models.ApplicationUser", "Actor")
                        .WithMany()
            ...
            modelBuilder.Entity("Booking.Models.TicketComment", b =>
                {
                    b.HasOne("Booking.Models.ApplicationUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Booking.Models.HousekeepingTicket", "Ticket")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("RoomRoomAmenity", b =>
                {
                    b.HasOne("Booking.Models.RoomAmenity", null)
                        .WithMany()
